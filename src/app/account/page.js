      ...
      <div className="mx-auto bg-gray-100 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow">
          <div className="p-6 sm:p-12">
            ...
            <div className="mt-6">
              <h1 className="font-bold text-lg">Direcciónes :</h1>
              {pageLevelLoader ? (
                <PulseLoader
                  color={"#000000"}
                ...
                <div className="mt-4 flex flex-col gap-4">
                  {addresses && addresses.length ? (
                    ...
                    <p>
                      Dirección no encontrada! por favor añade una dirección
                      abajo
                    </p>
                  )}
                </div>
            ...
            <div className="mt-4">
              <button
                ...
                className="mt-5  inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
              >
                {showAddressForm ? "Esconder formulario" : "Añadir dirección"}
              </button>
            </div>
            {showAddressForm ? (
